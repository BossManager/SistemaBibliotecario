...
public class BoardGerenteLivro extends JPanel{
	...
	private void initUI() {
		...
		tabela.setBorder(BorderFactory.createTitledBorder("Lista de Livros"));
		...
		add(voltar);
		ArrayList<Livro> leitores=LivroDAO.getLista();
		String []colunas= {"id","nome","autor","descricao","ano","categoria"};
		Object [][] objetos= Tools.getListObjects(leitores, 6);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				janela.add(new BoardGerenteLivro());
