...
public class BoardGerenteCliente extends JPanel{
	...
	private void initUI() {
		...
		tabela.setBorder(BorderFactory.createTitledBorder("Lista de Clientes"));
		...
		Object [][] objetos= Tools.getListObjectsLeitor(leitores, 6);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				...
				janela.add(new BoardGerenteCliente());
